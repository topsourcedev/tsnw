    ...
    class Model extends Base {
        ...
        public function getColumns() {
            if (empty($_columns)) {
                ...
                $boatswain = new Boatswain($this);
                $properties = $boatswain->getClassProperties();
                ...
                foreach ($properties as $property) {
                    $propertyMeta = $boatswain->getPropertyMeta($property);
        ...
        public static function first($where = array(), $fields = array("*"), $order = null, $direction = null, $deviate_table = "") {
            $model = new static(); //così se richiamo staticamente "first" da un oggetto di sottoclasse mi ritrovo 
            //con un oggetto della sottoclasse opportuna
            if (($deviate_table != "") && (is_string($deviate_table))) {
                $model->setTable($deviate_table);
            }
            $ff = $model->_first($where, $fields, $order, $direction);
            return $ff;
        }

        public function _first($where = array(), $fields = array("*"), $order = null, $direction = null) {
            $query = $this
              ->connector
              ->query()
        ...
        public static function all($where = array(), $fields = array("*"), $order = null, $direction = null, $limit = null, $page = null, $deviate_table = "") {
            $model = new static();
            if (($deviate_table != "") && (is_string($deviate_table))) {
                $model->setTable($deviate_table);
            }
            $ff = $model->_all($where, $fields, $order, $direction, $limit, $page);
            return $ff;
        }
