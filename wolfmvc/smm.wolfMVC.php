...
//            print_r($inserting_fields);
                ...
                die('Errore in Parte 1' . $e->getMessage());
            }
            while (count($inserting_fields) > 0 || $include_a_table) {
                ...
                try {
                    ...
                    die('Errore in Parte 2' . $e->getMessage());
                }
                ...
                if ($include_a_table)
                {
                    try {
                        ...
                        if ($current_table->belongsToEntity !== FALSE)
                        {
                            ...
                            echo "<br>Ricerca di tabelle nell'entità: ";
                            print_r($entity);
                            for ($i = 0; $i < (int) $entity->numberOfTables; $i++) {
                                echo "<br>Provo tabella " . "table_" . $i . " ::: " . $entity->{"table_" . $i};
...
//                                echo "<br>tabella " . $current_table_alias . " inserita";
                        ...
                        {
                            echo "<br> la tabella corrente non fa parte di un'entità";
                        }
                    } catch (\Exception $e) {
                        die('Errore in Parte 3' . $e->getMessage());
                    }
                    try {
                        ...
                        while ($include_a_table) {
                            ...
                            if (isset($relations[$current_table_alias]))
                            {
                                echo "<br>Situazione relazioni tabella corrente:<pre>";
                                print_r($relations[$current_table_alias]);
                                echo "</pre>";
                                ...
                                echo "<br>La tabella corrente non ha relazioni";
                            }
                            if ($include_a_table)
                        ...
                        die('Errore in Parte 4' . $e->getMessage());
                    }
                }
...
//                    $field = $fielddetails->expression;
                        ...
                        die('Errore in Parte 5' . $e->getMessage());
                    }
                }
                try {
                    echo "<br><br>checkcount: " . ($count - count($inserting_fields));
                    ...
                    die('Errore in Parte 6' . $e->getMessage());
                }
            }
            try {
                ...
                die('Errore in Parte 7' . $e->getMessage());
            }
            try {
                ...
                die('Errore in Parte 8' . $e->getMessage());
            }
            try {
                ...
                die('Errore in Parte 9' . $e->getMessage());
            }
            try {
                echo "<br>filtri:<br>";
                print_r($CONDS);
                ...
                die('Errore in Parte 10' . $e->getMessage());
            }
...
//            print_r($database);
                ...
                die('Errore in Parte 11' . $e->getMessage());
            }
        }
