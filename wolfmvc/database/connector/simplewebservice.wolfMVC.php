...
namespace WolfMVC\Database\Connector
{
    use WolfMVC\Database as Database;
    use WolfMVC\Database\Exception as Exception;
    
    class Simplewebservice extends Database\Connector
    {
        ...
        */
        ...
        protected function _isValidService()
        {
            ...
            $isInstance = $this->_service instanceof \WolfMVC\Library\Webservice;
...
//            echo "<br>connessione...<br>";
            ...
            {
//                echo "servizio trovato non valido...riscrivo...<br>";
