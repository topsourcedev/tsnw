(function() {
    var app = angular.module('ProgettiDaConfermare', ['ui.bootstrap'], function($interpolateProvider) {
    ...
    app.controller("ListoneController", function($scope, $http, $timeout) {
        ...
        this.linkURL = this.linkURL.split("progetti_da_confermare");
        this.linkURL = this.linkURL[0] + "conferma/";
